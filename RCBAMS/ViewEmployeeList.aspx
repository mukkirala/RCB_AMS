<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ViewEmployeeList.aspx.cs" Inherits="ViewEmployeeList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
     ...
     <table style="margin-right:20px">
        <tr>
            <td class="style10">
            <span><strong>Employee Details</strong></span>
            </td>
        ...
        <dx:ASPxGridView ID="ViewAssetRequest"  runat="server" AutoGenerateColumns="False" 
                    DataSourceID="SqlCustodianMaster" KeyFieldName="CustodianID"              
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="CustodianDepartmentCode" Visible="false" VisibleIndex="2" Caption="Employee Department">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>

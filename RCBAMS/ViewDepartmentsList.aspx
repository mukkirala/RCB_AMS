<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ViewDepartmentsList.aspx.cs" Inherits="ViewDepartmentsList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
     ...
     <table style="margin-right:20px">
        <tr>
            <td class="style10">
            <span><strong>Department Details</strong></span>
            </td>
        ...
        <dx:ASPxGridView ID="ViewAssetRequest"  runat="server" AutoGenerateColumns="False" 
                    DataSourceID="SqlDepartmentMaster" KeyFieldName="DepartmentCode"              
                    CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" CssPostfix="PlasticBlue" 
                    Width="1100px">
        <Columns>
            <dx:GridViewDataTextColumn FieldName="DepartmentCode" ReadOnly="True" VisibleIndex="1" Caption="Department Code" Visible="false">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
            
            <dx:GridViewDataTextColumn FieldName="DepartmentName" VisibleIndex="2" Caption="Department Name">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>  

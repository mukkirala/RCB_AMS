<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ViewCompletedAudits.aspx.cs" Inherits="ViewCompletedAudits" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
 <div class="col-sm-12" runat="server">
      <table style="margin-right:15px">
        <tr>
            <td class="style10">
              <h4> <span><strong>View Completed Audits</strong></span></h4>
            </td>
    ...
    <dx:ASPxGridView ID="ASPxGridView2"  runat="server" AutoGenerateColumns="False" 
                    DataSourceID="SqlDSGrid" KeyFieldName="AuditID"   Width="98%"                

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ApproverGeneralComplaintsDetails.aspx.cs" Inherits="ApproverGeneralComplaintsDetails" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
        ...
        <div class=" row cnt_div">
             <dx:ASPxLabel ID="lbl_msg" runat="server" ForeColor="Red" Text=""></dx:ASPxLabel>
            	<div class="col-sm-12">
             <h4>  <strong>General  Complaint Resolution</strong></h4>
                    </div>
            ...
            <div class="clearfix"></div><br />
                   ...
                   <dx:ASPxGridView ID="ASPxGridView1" OnRowCommand="ASPxGridView1_RowCommand" runat="server" Width="80%"  AutoGenerateColumns="False" CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" CssPostfix="PlasticBlue" DataSourceID="SqlDataSource1" KeyFieldName="ComplaintID">
                       <Columns>

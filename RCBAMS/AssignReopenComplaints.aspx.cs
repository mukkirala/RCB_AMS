...
public partial class AssignReopenComplaints : System.Web.UI.Page
{
    ...
    protected void btn_save_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            try
            {
                ...
                SqlCommand cmd4 = new SqlCommand("update ComplaintTransaction set ApproverComments=@ApproverComments, AssignedTo=@AssignedTo,AssignedDate=@AssignedDate,Status=@Status where[ComplaintTransactionID] = '" + Session["ComplaintTransactionID"] + "'", con);
                ...
                lbl_msg.Text = "Complaint Assign to Enginner";
    ...
    public void SendSMS()
    {
        ...
        string Message = "Your Complaint Number" + Session["ComplaintID"] + " has been resolved. Please check details on portal/mobile app.NEEMUS";
    ...
    //    //if (cmb_tech.Text == "")
    //    //{
    //    //    ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('Please Select Technician');", true);
    //    //}
    //     if (Memo_remarks.Text == "")
    //    {
    //        ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('Please Enter Remarks');", true);
    ...
    //            SqlCommand cmd = new SqlCommand("Update ComplaintTransaction set Remarks='" + Memo_remarks.Text + "',Status='"+ cmb_jobDefect.Text + "' where [ComplaintID]='" + Session["ComplaintID"] + "' ", con);
    ...
    {
        Response.Redirect("ViewEscalatedComplaints");

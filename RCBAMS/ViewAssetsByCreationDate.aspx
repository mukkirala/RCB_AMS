<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ViewAssetsByCreationDate.aspx.cs" Inherits="ViewAssetsByCreationDate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
 ...
 <strong><span class="style6"><span class="dxmLite_Glass">
    Print QRCode by Asset Created Date<br />
</span></span></strong>
    ...
    <table width="800px">
        <tr>
            <td class="style2">
                Select Date </td>
            <td class="style3">                
                <dx:ASPxDateEdit ID="txtDate" runat="server" Height="25px" CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" CssPostfix="PlasticBlue" SpriteCssFilePath="~/App_Themes/PlasticBlue/{0}/sprite.css" DisplayFormatString="dd-MM-yyyy" >
                    <ValidationSettings>
    ...
    <asp:SqlDataSource ID="SqlDSGrid" runat="server" ConnectionString="<%$ ConnectionStrings:RCBSAPConnectionString %>" SelectCommand="Select * from RCBSAP..vAssetMaster where CreatedDate=@CreationDate">
     ...
     <table class="style8" width="460px">
        <tr>
            <td class="style9">

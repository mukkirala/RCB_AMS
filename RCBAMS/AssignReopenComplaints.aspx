                    ...
                    <asp:LinkButton ID="view" runat="server" CommandName="view">View Document</asp:LinkButton>
                       ...
                       <styleseditors>
                           ...
                           <progressbar height="25px">
						            ...
						            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RCBAMSConnectionString %>" SelectCommand="SELECT [ComplaintID],ComplaintCode, [FilePath] FROM [ComplaintRegistration] where ComplaintID=@ComplaintID ">
                                        <SelectParameters>

...
public partial class CustodianDashboard : System.Web.UI.Page
{
    ...
    void updates_fa()
    {
        ...
        string select1 = "SELECT EmployeeAssetRequest.EmployeeID FROM RCBAMS..EmployeeAssetRequest where EmployeeID = '" + Session["UserID"].ToString() + "' and Status='Request Sent To Approver'";
        ...
        string select2 = "SELECT EmployeeAssetReturn.EmployeeID FROM RCBAMS..EmployeeAssetReturn where EmployeeID = '" + Session["UserID"].ToString() + "' and Status='Request Sent To Approver'";
        ...
        string select3 = "SELECT EmployeeLocationChange.EmployeeID FROM RCBAMS..EmployeeLocationChange where EmployeeID = '" + Session["UserID"].ToString() + "' and Status='Request Sent To Approver'";
        ...
        string select4 = "SELECT CustodianChangeRequest.EmployeeID FROM RCBAMS..CustodianChangeRequest where EmployeeID = '" + Session["UserID"].ToString() + "' and Status='Request Sent To Approver'";
        ...
        //string select5 = "SELECT EmployeeAssetBuyBack.EmployeeID FROM RCBAMS..EmployeeAssetBuyBack where EmployeeID = '" + Session["UserID"].ToString() + "' and Status='Request Sent To Approver'";

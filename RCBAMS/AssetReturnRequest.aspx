<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AssetReturnRequest.aspx.cs" Inherits="AssetReturnRequest" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
 <asp:UpdatePanel ID="updpnlRefresh" runat="server" UpdateMode="Conditional">
  <ContentTemplate>
    <div class="col-sm-12">
      <h4><strong><span>Asset Return</span></strong></h4>
    <div class="">
        <div class="row">
        <div style="">
             <div class="col-sm-12">
      ...
      <SettingsPager PageSize="15"></SettingsPager>
                    ...
                    <Columns>
                        ...
                        <dx:gridviewdatatextcolumn FieldName="AssetSubNumber" VisibleIndex="2">
                        </dx:gridviewdatatextcolumn>
         ...
         <div class="col-sm-4">
           ...
           <%-- <div class="col-sm-10">
                <div class="row">
                    ...
                    <div class="col-sm-2">
                          <dx:ASPxLabel ID="ASPxLabel4" runat="server" Text="MainAssetNumber"></dx:ASPxLabel>
                         
                    </div>
                    <div class="col-sm-2">
                        <dx:ASPxLabel ID="ASPxLabel5" runat="server" Text="123456"></dx:ASPxLabel>
                    </div>
                </div>
            </div>--%>
            <div class="col-sm-10">
 ...
 <div class="clearfix"></div>
    ...
    <dx:ASPxGridView ID="AssetList" runat="server" AutoGenerateColumnsASPxGridView1="False" 
        ...
        <Columns>
            ...
            <%--<dx:GridViewDataTextColumn FieldName="SerialNumber"   ReadOnly="True" VisibleIndex="3" Caption="Serial Number">
   <Settings AutoFilterCondition="Contains" />
 </dx:GridViewDataTextColumn>--%> 
            <%--<dx:GridViewDataTextColumn FieldName="Model"   ReadOnly="True" VisibleIndex="3" Caption="Model">
   <Settings AutoFilterCondition="Contains" />
                </dx:GridViewDataTextColumn> --%>
                <%--<dx:GridViewDataTextColumn FieldName="Make"   ReadOnly="True" VisibleIndex="3" Caption="Make">
   <Settings AutoFilterCondition="Contains" />
                    </dx:GridViewDataTextColumn> --%>
                    <%--<dx:GridViewDataTextColumn FieldName="PONoforReference"   ReadOnly="True" VisibleIndex="3" Caption="PO Number">
   <Settings AutoFilterCondition="Contains" />
                        </dx:GridViewDataTextColumn> --%>
...
<%-- </dx:GridViewDataTextColumn> 
             ...
             <dx:GridViewDataTextColumn FieldName="ReturnSequene" VisibleIndex="3" Caption="Staff Number">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="Requestedby" VisibleIndex="3" Caption="User Name">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
            ...
            <dx:GridViewDataTextColumn FieldName="CustodianComments" VisibleIndex="4" Caption="User Comments">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
            <%--<dx:GridViewDataTextColumn FieldName="CustodianComments" VisibleIndex="4">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>--%>
            <dx:GridViewDataTextColumn FieldName="Date" VisibleIndex="5" Width="100px" >

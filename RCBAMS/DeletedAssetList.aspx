<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DeletedAssetList.aspx.cs" Inherits="DeletedAssetList" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="col-sm-12">
     ...
     <table style="margin-right:20px">
        ...
        <tr>
            <td class="style10">
            <h4><span><strong>Deleted Assests</strong></span></h4>
            </td>
        ...
        <dx:ASPxGridView ID="ASPxGridView1"  runat="server" AutoGenerateColumns="False" 
                    DataSourceID="SqlDSGrid" KeyFieldName="SLNO"        OnRowCommand="ASPxGridView1_RowCommand"          
                    CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" CssPostfix="PlasticBlue" 
                    Width="95%">
       <Columns>
           <dx:GridViewDataTextColumn FieldName="" VisibleIndex="0" CellStyle-Font-Bold="true">
                <DataItemTemplate>
                    <asp:LinkButton ID="lnkbtn_edit" runat="server" Text="Recover" CommandName="Recover" ForeColor="Green"></asp:LinkButton>
                    </DataItemTemplate>
    ...
    <Settings AutoFilterCondition="Contains" />
            ...
            <dx:GridViewDataTextColumn FieldName="CapitalizationDate" VisibleIndex="18" Caption="Capitalization Date" Visible="false">
             ...
             <dx:GridViewDataTextColumn FieldName="CostCenter" VisibleIndex="20" Caption="Cost Center" Width="80px" >

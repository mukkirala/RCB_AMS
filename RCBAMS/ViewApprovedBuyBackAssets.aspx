<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ViewApprovedBuyBackAssets.aspx.cs" Inherits="ViewApprovedBuyBackAssets" %>
...
<div class="col-sm-12">
    ...
    <div class="table-responsive" >
      ...
      <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumnsASPxGridView1="False" 
        ...
        DataSourceID="SqlDataSource1" KeyFieldName="BuybackRequestID" 
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="EmployeeID" ReadOnly="True" VisibleIndex="3" Caption="Requestor ID">
             ...
             <dx:GridViewDataTextColumn FieldName="Requestedby" ReadOnly="True" VisibleIndex="4"  Caption="Requestor Name">
              ...
              <dx:GridViewDataTextColumn FieldName="CustDepartmentCode" ReadOnly="True" VisibleIndex="5"  Caption="Department Code" Visible="false">
                <Settings AutoFilterCondition="Contains" />
              </dx:GridViewDataTextColumn>
 ...
 where EmployeeAssetBuyback.Status='Approved' order by BuybackRequestID desc">
    ...
    <br />
<div >
        <strong><span class="">Rejected Buyback Assets</span></strong>
    </div>  
    <div class="table-responsive" >

    <dx:ASPxGridView ID="ASPxGridView2" runat="server" AutoGenerateColumnsASPxGridView1="False" 
          
        DataSourceID="SqlDataSource2" KeyFieldName="BuybackRequestID" 
        CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" 
        CssPostfix="PlasticBlue" AutoGenerateColumns="False"  style="width:100%" >
        <Columns>
              <dx:GridViewDataTextColumn FieldName="BuybackRequestID" ReadOnly="True" VisibleIndex="0" Visible="false">

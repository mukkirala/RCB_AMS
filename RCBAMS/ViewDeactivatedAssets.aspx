<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ViewDeactivatedAssets.aspx.cs" Inherits="ViewDeactivatedAssets" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
   <div class="col-sm-12" >
     ...
     <table style="margin-right:20px">
        <tr>
            <td class="style10">
           <span><strong>Assets Deactivated</strong></span>
            </td>
    ...
    <asp:SqlDataSource ID="SqlDSGrid" runat="server" ConnectionString="<%$ ConnectionStrings:InstemSAPConnectionString %>" SelectCommand="Select * from InstemSAP..AssetMaster where AssetMaster.Status='DACT'"></asp:SqlDataSource>                                     

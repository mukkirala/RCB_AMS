<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="BuybackRequest.aspx.cs" Inherits="BuybackRequest" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
 <asp:UpdatePanel ID="updpnlRefresh" runat="server" UpdateMode="Conditional">
  <ContentTemplate>
    <div class="col-sm-12">
      <h4><strong><span>Request For Buyback</span></strong></h4>
    <div class="">
        <div class="row">
        <div style="">
             <div class="col-sm-12">
           <dx:ASPxLabel ID="errormsg" runat="server" Text="" Visibl="false" ForeColor="Red"></dx:ASPxLabel>
            ...
            <div class="col-sm-10">
                ...
                <div class="col-sm-2">
                    <dx:ASPxLabel ID="ASPxLabel4" runat="server" Text="Staff Number:"></dx:ASPxLabel>                 
                </div>
                <div class="col-sm-4">
                     <dx:ASPxLabel ID="reqid" runat="server" Text="" ForeColor="Blue"></dx:ASPxLabel>
                </div>
                <div class="col-sm-2">
                    <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text="User Name:"></dx:ASPxLabel>                 
                </div>
                <div class="col-sm-4">
                ...
                <div class="col-sm-4">
                    <dx:ASPxLabel ID="lblmail" runat="server" Text="" ForeColor="Blue"></dx:ASPxLabel>
                </div>
                <div class="col-sm-2">
                    <dx:ASPxLabel ID="ASPxLabel9" runat="server" Text="Reporting Authority:"></dx:ASPxLabel>                                
                </div>
                <div class="col-sm-4">
                     <dx:ASPxLabel ID="lbl_auth" runat="server" Text="" ForeColor="Blue"></dx:ASPxLabel>
                </div>
                </div>
                <div class="row form_div">
      ...
      <SettingsPager PageSize="5"></SettingsPager>
                    ...
                    <Columns>
                        ...
                        <dx:gridviewdatatextcolumn FieldName="MainAssetNumber" VisibleIndex="2" Caption="MainAssetNumber">
                        </dx:gridviewdatatextcolumn>
						 <dx:gridviewdatatextcolumn FieldName="AssetSubNumber" VisibleIndex="3" Caption="SubNumber">
                        </dx:gridviewdatatextcolumn>
         ...
         <div class="col-sm-12">
          <div class="row form_div">
           ...
           <div class="col-sm-4">
            ...
            <div class="col-sm-2">
               <dx:ASPxLabel ID="Label2" runat="server" Text="Sub Number:"></dx:ASPxLabel>
           ...
           <div class="row form_div">
            <div class="col-sm-2">
              <dx:ASPxLabel ID="Label3" runat="server" Text="Asset Class:"></dx:ASPxLabel>
           ...
           <div class="col-sm-2">
                <dx:ASPxLabel ID="Label4" runat="server" Text="Asset Type:"></dx:ASPxLabel>
    ...
    <div class="row form_div">
         <div class="col-sm-2">
           <dx:ASPxLabel ID="Label5" runat="server" Text="Asset Location:"></dx:ASPxLabel>
         </div>
         <div class="col-sm-4">
         ...
         <div class="col-sm-4">
            ...
            <div class="col-sm-10">
                 <div class="row form_div">
                <div class="col-sm-2">
                    <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text="Comments"></dx:ASPxLabel>
                </div>
                <div class="col-sm-4">
             ...
             <div class="col-sm-10">
                 <div class="row form_div">
                     ...
                     <div class="col-sm-4">
                    <dx:ASPxButton ID="ASPxButton1" runat="server" Text="Send Request" OnClick="ASPxButton1_Click">
     ...
     <dx:ASPxGridView ID="AssetList" runat="server" AutoGenerateColumnsASPxGridView1="False" 
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="AssetID"  ReadOnly="True" VisibleIndex="1" visible="false">
			 ...
			 <dx:GridViewDataTextColumn FieldName="MainAssetNumber"  ReadOnly="True" VisibleIndex="1">
                <Settings AutoFilterCondition="Contains" />
              </dx:GridViewDataTextColumn> 
			 <dx:GridViewDataTextColumn FieldName="AssetSubNumber" Caption="SubNumber"  ReadOnly="True" VisibleIndex="1">
                <Settings AutoFilterCondition="Contains" />
              </dx:GridViewDataTextColumn> 
            <dx:GridViewDataTextColumn FieldName="AssetTypeName"  ReadOnly="True" VisibleIndex="2" caption="AssetName">
                <Settings AutoFilterCondition="Contains" />
              </dx:GridViewDataTextColumn> 
             <dx:GridViewDataTextColumn FieldName="EmployeeID" VisibleIndex="7" Caption="Staff Number">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>

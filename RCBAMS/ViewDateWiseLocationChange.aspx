<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ViewDateWiseLocationChange.aspx.cs" Inherits="ViewDateWiseLocationChange" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <span class="auto-style7">View DateWise LocationChange </span><span class="auto-style1"><br /></span>
    <br />
     ...
     <%--   <tr>
        ...
        <tr>
            ...
            <td class="auto-style12">
                &nbsp;</td>
            <td>
                <dx:ASPxButton ID="ASPxButton3" runat="server" onclick="ASPxButton3_Click1" CssFilePath="~/App_Themes/SoftOrange/{0}/styles.css" CssPostfix="SoftOrange" SpriteCssFilePath="~/App_Themes/SoftOrange/{0}/sprite.css"  
                    Text="Search">
                </dx:ASPxButton>
...
<br />
    ...
    CssClass="auto-style9" KeyFieldName="LocationChangeID" >
        <Columns>
            <dx:GridViewDataTextColumn FieldName="LocationChangeID" ReadOnly="True" 
                VisibleIndex="0" ShowInCustomizationForm="True" Width="25px"  Visible="False" >
                <EditFormSettings Visible="False" />
            </dx:GridViewDataTextColumn>
             <dx:GridViewDataTextColumn FieldName="AssetID" Caption="Asset ID."
            ...
            <dx:GridViewDataDateColumn Width="100px" Caption="RequstedDate" FieldName="Date" VisibleIndex="3" 
                ShowInCustomizationForm="True" >
             <PropertiesDateEdit DisplayFormatString="dd-MM-yyyy"></PropertiesDateEdit>
            </dx:GridViewDataDateColumn>
            <dx:GridViewDataTextColumn FieldName="CustodianComments" VisibleIndex="4" 
                ShowInCustomizationForm="True" Width="25px">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="ApproverComments" VisibleIndex="5" Width="50px" Visible="false" 
                ShowInCustomizationForm="True">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataDateColumn FieldName="AdminDate" VisibleIndex="6" Width="100px"
                ShowInCustomizationForm="True">
                <PropertiesDateEdit DisplayFormatString="dd-MM-yyyy"></PropertiesDateEdit>
            </dx:GridViewDataDateColumn>
         
           
            <dx:GridViewDataTextColumn FieldName="ApproverName" VisibleIndex="7"  Visible="false"
                ShowInCustomizationForm="True">
            </dx:GridViewDataTextColumn>
             <dx:GridViewDataTextColumn FieldName="RequestBy" Width="25px" Caption="Request By" 
              ...
              <dx:GridViewDataTextColumn FieldName="RequestType" Width="25px" 
                ShowInCustomizationForm="True" VisibleIndex="8" Caption="Request Type">
            </dx:GridViewDataTextColumn>
        ...
        <Settings ShowFooter="true" ShowGroupFooter="VisibleIfExpanded" 
            ShowFilterRow="True" />
        <GroupSummary>
            <dx:ASPxSummaryItem FieldName="LocationChangeID" SummaryType="Count" />
        </GroupSummary>
       <TotalSummary>
           <dx:ASPxSummaryItem FieldName="LocationChangeID" SummaryType="Count" Tag="No of Location Changes Request"/>
       </TotalSummary>
...
                                     
   ...
   <%-- <asp:SessionParameter Name="VisitorType" SessionField="VisitorType" />--%>
    ...
    <dx:ASPxGridViewExporter ID="ASPxGridViewExporter1" GridViewID="ViewLocationChange" 

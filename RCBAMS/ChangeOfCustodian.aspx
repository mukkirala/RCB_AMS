<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ChangeOfCustodian.aspx.cs" Inherits="ChangeOfCustodian" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
 <div class="col-sm-12">
     ...
     <h4><strong>Requester Details</strong></h4>
        ...
        <div class="row form_div">
            ...
            <div class="col-sm-2">
                <dx:ASPxLabel ID="ASPxLabel6" runat="server" Text="Transfer To Employee:" Font-Size="Large"></dx:ASPxLabel> 
            </div>
            <div class="col-sm-4">
    ...
    <div class="row">   <div class="col-sm-12"><h4><strong>Asset Details</strong></h4>
      ...
      <div class="row form_div">
         <div class="col-sm-2">
             <dx:ASPxLabel ID="ASPxLabel8" runat="server" Text="Requested Asset:" Font-Size="Large"></dx:ASPxLabel> 
         </div>
         <div class="col-sm-4">
         ...
         <div class="col-sm-2">
             <dx:ASPxLabel ID="ASPxLabel9" runat="server" Text="Asset Number:" Font-Size="Large"></dx:ASPxLabel> 
 ...
 <div class="row form_div">
         <div class="col-sm-2">
             <dx:ASPxLabel ID="ASPxLabel11" runat="server" Text="Asset Sub Number:" Font-Size="Large"></dx:ASPxLabel> 
         </div>
         <div class="col-sm-4">
         ...
         <div class="col-sm-2">
             <dx:ASPxLabel ID="ASPxLabel12" runat="server" Text="Asset Class:" Font-Size="Large"></dx:ASPxLabel> 
 ...
 <div class="row form_div">
         <div class="col-sm-2">
             <dx:ASPxLabel ID="ASPxLabel13" runat="server" Text="Current Location:" Font-Size="Large"></dx:ASPxLabel> 
         </div>
         <div class="col-sm-4">
         ...
         <div class="col-sm-2">
             <dx:ASPxLabel ID="ASPxLabel14" runat="server" Text="Asset Status:" Font-Size="Large"></dx:ASPxLabel> 
         </div>
         <div class="col-sm-4">
     ...
     <div class="row form_div">
         <div class="col-sm-2">
             <dx:ASPxLabel ID="ASPxLabel15" runat="server" Text="Available Quantity:" Font-Size="Large"></dx:ASPxLabel> 
         </div>
         <div class="col-sm-4">
         ...
         <div class="col-sm-2">
             <dx:ASPxLabel ID="ASPxLabel16" runat="server" Text="Component:" Font-Size="Large"></dx:ASPxLabel> 
         </div>
         <div class="col-sm-4">
     ...
     <div class="row form_div">
         <div class="col-sm-2">
             <dx:ASPxLabel ID="ASPxLabel17" runat="server" Text="Capitalization Date:" Font-Size="Large"></dx:ASPxLabel> 
         </div>
         <div class="col-sm-4">
         ...
         <div class="col-sm-2"> 
             <dx:ASPxLabel ID="ASPxLabel18" runat="server" Text="First Acquisition Date:" Font-Size="Large"></dx:ASPxLabel> 
         </div>
         <div class="col-sm-4">
     ...
     <div class="row form_div">
         <div class="col-sm-2">
             ...
             <dx:ASPxLabel ID="ASPxLabel19" runat="server" Text="DeacDate:" Font-Size="Large"></dx:ASPxLabel> 
         </div>
         <div class="col-sm-4">
         ...
         <div class="col-sm-2">
             ...
             <dx:ASPxLabel ID="ASPxLabel20" runat="server" Text="Inventory Note:" Font-Size="Large"></dx:ASPxLabel> 
         </div>
         <div class="col-sm-4">
     ...
     <div class="row form_div">
         <div class="col-sm-2">
             ...
             <dx:ASPxLabel ID="ASPxLabel21" runat="server" Text="Inventory Date::" Font-Size="Large"></dx:ASPxLabel> 
         </div>
         <div class="col-sm-4">
         ...
         <div class="col-sm-4">
            <dx1:ASPxLabel ID="ASPxLabel10" runat="server"  Text="" Font-Bold="True" ForeColor="Black" Font-Size="Medium">
	        </dx1:ASPxLabel>           
         </div>
     </div>
       ...
       <strong></strong>
        ...
        <div class="row form_div">
         <div class="col-sm-2">   
             <dx:ASPxLabel ID="ASPxLabel22" runat="server" Text="Remarks:" Font-Size="Large"></dx:ASPxLabel> 
         </div>
         <div class="col-sm-4">
    ...
    InitialValue="" ErrorMessage="Please enter a comment." ForeColor="Red"></asp:RequiredFieldValidator>
         ...
         <div class="col-sm-2">
          ...
          <div class="col-sm-4">
                 ...
                 <div class="row form_div">
           <div class="col-sm-1">
                 <dx:ASPxButton ID="ASPxButton1" runat="server" Text="Approve" OnClick="ASPxButton1_Click" CssFilePath="~/App_Themes/SoftOrange/{0}/styles.css" CssPostfix="SoftOrange" 
        SpriteCssFilePath="~/App_Themes/SoftOrange/{0}/sprite.css"></dx:ASPxButton>
           </div>
            <div class="col-sm-4">
                
			<dx:ASPxButton ID="ASPxButton2" runat="server" Text="Reject" OnClick="ASPxButton2_Click" CssFilePath="~/App_Themes/SoftOrange/{0}/styles.css" CssPostfix="SoftOrange" 
        SpriteCssFilePath="~/App_Themes/SoftOrange/{0}/sprite.css"></dx:ASPxButton>
            </div> 

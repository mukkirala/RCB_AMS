...
public class Utilities
{
    ...
    static SqlConnection sqlcon = new SqlConnection(WebConfigurationManager.ConnectionStrings["ASSETManagementConnectionString"].ConnectionString);
   ...
   return decodedstrings ;
    ...
    public static Bitmap CreateBitmapImage(string sImageText)
    {
       ...
       objBmpImage.SetResolution(96.0F, 96.0F);
        ...
        Font objFont = new Font("Arial Narrow", 20, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Pixel);

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ViewAssetbyDepartment.aspx.cs" Inherits="ViewAssetbyDepartment" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
      <div class="col-sm-12">
 <strong><span>
    Asset Details As Per Department<br /></span></strong>
      <div class="col-sm-10">
           <br />
       </div>
            <div class="col-sm-12">
  ...
  <asp:SqlDataSource ID="SqbDBaircraft" runat="server" 
                        ...
                        SelectCommand="SELECT DISTINCT [Department] FROM [AssetMaster] "></asp:SqlDataSource>
 ...
 <div >
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RCBSAPConnectionString %>" 
        ...
        <SelectParameters>
    <asp:ControlParameter Name="Department" ControlID="cmb_Dep"/>
</SelectParameters>

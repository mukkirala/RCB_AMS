...
public partial class RequestDetails : System.Web.UI.Page
{
    ...
    protected void GetAllRequestDetails(string RequestID,string RequestType,string status)
    {
        ...
        {
            string select3 = "SELECT LocationChangeID,AssetID,EmployeeID,Status,Date,CustodianComments,ApproverComments,ToLocation,AdminComments,CustodianDepartment,CustDepartmentCode,CustDesignation,RequestBy,ApproverID,ApproverName,ApproverDesignation,ApproverDeptCode,ApproverDepartment,AdminID,AdminName,AdminDesignation,AdminDeptCode,AdminDepartment,RequestType FROM EmployeeLocationChange where LocationChangeID='"+RequestID+"'";
        ...
        if(RequestType== "Custodian Transfer")
        {

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AdminViewGEPendingComplaints.aspx.cs" Inherits="AdminViewGEPendingComplaints" %>
...
select ComplaintRegistration.Status,ComplaintRegistration.CreatedDate,ComplaintCode,EmployeeName,
...
where ComplaintRegistration.Status='Pending' and ComplaintTransaction.Status='Pending'">
                          <%-- <SelectParameters>
         ...
         <div class="col-sm-12"><br/></div> 
                <h5>  <strong>Assigned  Complaints</strong></h5>
              <div class="col-sm-12">
...
select ComplaintRegistration.Status,ComplaintRegistration.CreatedDate,ComplaintCode,EmployeeName,ServiceTypeName,ComplaintRegistration.Complaint_Description,
                           ComplaintRegistration.ComplaintID
from ComplaintRegistration
inner join ComplaintTransaction on ComplaintTransaction.ComplaintID=ComplaintRegistration.ComplaintID
inner join ServiceTypeMaster on ServiceTypeMaster.ServiceTypeID=ComplaintRegistration.ServiceTypeID
 where ComplaintRegistration.Status='Assign' and ComplaintTransaction.Status='Assign'">
                           <%--<SelectParameters>
                               <asp:SessionParameter Name="LocationID" SessionField="LocationID" />
                           </SelectParameters>--%>
                       </asp:SqlDataSource>

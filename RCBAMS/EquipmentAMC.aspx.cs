...
public partial class EquipmentAMC : System.Web.UI.Page
{
    ...
    protected void btn_save_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            using (SqlConnection con = new SqlConnection(connStr))
            {
                ...
                {
                    string query = @"INSERT INTO EquipmentCalibration
                ...
                {
                    string query = @"UPDATE EquipmentCalibration 
                SET AssetID=@AssetID,
    ...
    protected void grid_EquipmentAMC_CustomButtonCallback(object sender, DevExpress.Web.ASPxGridView.ASPxGridViewCustomButtonCallbackEventArgs e)
    {
        ...
        if (e.ButtonID == "Delete")
        {
            ...
            using (SqlConnection con = new SqlConnection(connStr))
            {
                string query = "DELETE FROM EquipmentCalibration WHERE CalibrationID=@CalibrationID";

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="EquipmentAMC.aspx.cs" Inherits="EquipmentAMC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="container-fluid cnt_div">
    	 <div class="col-sm-12">
 <div class="col-sm-10">
<h4>Equipment calibration services</h4>
         </div>
             </div>
        <div class="col-sm-12">
...
<div class="col-sm-2">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
Main Asset Number <span style="color:red">*</span>
</div>
...
<dx:GridViewDataTextColumn FieldName="MainAssetNumber" Caption="Main Asset Number">
     <Settings AutoFilterCondition="Contains" />
    </dx:GridViewDataTextColumn>
<dx:GridViewDataDateColumn FieldName="CalibrationOn" Caption="Last Calibration Date">
<PropertiesDateEdit DisplayFormatString="dd-MM-yyyy"></PropertiesDateEdit>
</dx:GridViewDataDateColumn>

<dx:GridViewDataDateColumn FieldName="CalibrationDue" Caption="Next Calibration Date">
<PropertiesDateEdit DisplayFormatString="dd-MM-yyyy"></PropertiesDateEdit>
</dx:GridViewDataDateColumn>
...
ConnectionString="<%$ ConnectionStrings:RCBSAPConnectionString %>"
SelectCommand="SELECT CalibrationID, AssetID, MainAssetNumber, MaintenanceContract, CalibrationOn, CalibrationDue FROM EquipmentCalibration">
</asp:SqlDataSource>

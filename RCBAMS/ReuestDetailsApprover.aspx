<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ReuestDetailsApprover.aspx.cs" Inherits="ReuestDetailsApprover" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
 ...
 <div class="col-sm-12">
    ...
    <h4> <strong>Requester Details</strong></h4>
            ...
            <div class="col-sm-4">
                <dx:ASPxLabel ID="reqid" runat="server" Font-Bold="true"  Font-Size="Medium" ForeColor="Black" Text="">
						 </dx:ASPxLabel>            
            </div>    
            <div class="col-sm-2"  style="Font-Size:Medium">
            ...
            <div class="col-sm-4">
                 <dx:ASPxLabel ID="lbl_empname" runat="server"  Font-Size="Medium" Font-Bold="true" ForeColor="Black" Text="">
						 </dx:ASPxLabel>        
            </div>
        </div>
         <div class="row form_div">
            ...
            <div class="col-sm-4">
                <dx1:ASPxLabel ID="reqdeptname" runat="server" Font-Size="Medium" Text="" ForeColor="Black" Font-Bold="True">
						 </dx1:ASPxLabel>           
            </div>
             <div class="col-sm-2" style="Font-Size:Medium">
         ...
         <div class="col-sm-4">
            <dx1:ASPxLabel ID="lbl_reqQuantity" runat="server"  Text="" Font-Bold="True" Font-Size="Medium" ForeColor="Black">
						 </dx1:ASPxLabel>            
         </div>
     </div>
          <div class="row form_div">
    ...
    <div class="row form_div">
         ...
         <div class="col-sm-4">
             <dx1:ASPxLabel ID="lbl_reqasset" runat="server" ForeColor="Black" Font-Size="Medium" Text="" Font-Bold="True">
		   </dx1:ASPxLabel>            
         </div>   
         <div class="col-sm-2" style="Font-Size:large">
          ...
          <div class="col-sm-4">
                <dx1:ASPxLabel ID="lbl_mainassetnumber" runat="server" ForeColor="Black" Text="" Font-Size="Medium" Font-Bold="True">
	            </dx1:ASPxLabel>             
         </div>
    </div>
    <div class="row form_div">
         ...
         <div class="col-sm-4">
             <dx1:ASPxLabel ID="lbl_subnumber" runat="server" ForeColor="Black" Font-Size="Medium" Text="" Font-Bold="True">
		   </dx1:ASPxLabel>           
         </div>     
         <div class="col-sm-2" style="Font-Size:large">
          ...
          <div class="col-sm-4">
            <dx1:ASPxLabel ID="lbl_assetclass" runat="server" ForeColor="Black" Font-Size="Medium" Text="" Font-Bold="True">
	        </dx1:ASPxLabel>            
         </div>
     </div>
      ...
      <div class="row form_div">
         ...
         <div class="col-sm-4">
             <dx1:ASPxLabel ID="lbl_assetstatus" runat="server"  Text="" Font-Bold="True" Font-Size="Medium" ForeColor="Black">
	        </dx1:ASPxLabel>           
         </div>     
         <div class="col-sm-2" style="Font-Size:large">

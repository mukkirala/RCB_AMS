...
public partial class EngineerViewGEPendingComplaints : System.Web.UI.Page
{
    ...
    //{
    //    Session["ComplaintID"] = ASPxGridView2.GetRowValuesByKeyValue(e.KeyValue, "ComplaintID").ToString();


    //    Response.Redirect("~/WorkInProgressComplaints.aspx");

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AssignReopenComplaints.aspx.cs" Inherits="AssignReopenComplaints" %>
            ...
            <div class="clearfix"></div><br />
                 ...
                 <%--  <dx:ASPxGridView ID="ASPxGridView1" OnRowCommand="ASPxGridView1_RowCommand" runat="server" Width="100%" OnCustomUnboundColumnData="ASPxGridView1_CustomUnboundColumnData" AutoGenerateColumns="False" CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" CssPostfix="PlasticBlue" DataSourceID="SqlDataSource1" KeyFieldName="ComplaintID">
                       <Columns>
                           ...
                           <dx:GridViewDataTextColumn FieldName="FilePath" VisibleIndex="2">
                                <DataItemTemplate>
                    <asp:LinkButton ID="view" runat="server" CommandName="view">View Document</asp:LinkButton>
                       ...
                       <styleseditors>
                           ...
                           <progressbar height="25px">
						            ...
						            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:InstemAMSConnectionString %>" SelectCommand="SELECT [ComplaintID],ComplaintCode, [FilePath] FROM [ComplaintRegistration] where ComplaintID=@ComplaintID ">
                                        <SelectParameters>
               ...
               <div class="col-sm-12">
                <div class="col-sm-2">
                    <dx:ASPxLabel ID="ASPxLabel9" runat="server" Text="Assign to Engineer" Font-Bold="true"></dx:ASPxLabel>
                </div>
                <div class="col-sm-3">
			 ...
			 <div class="col-sm-12">
                 ...
                 <div class="col-sm-2">
                     <dx:ASPxLabel ID="ASPxLabel7" runat="server" Text="Comments" Font-Bold="true"></dx:ASPxLabel>
                 </div>
                 <div class="col-sm-4">
  ...
  <%--      </Columns>
    ...
    <span class="auto-style59">
			 ...
			 <div class="col-sm-12">
                ...
                <div class="col-sm-2">
                     <dx:ASPxButton ID="btn_save" runat="server" Text="Save" Width="100px" Onclick="btn_save_Click" ValidationGroup="btn"  CssFilePath="~/App_Themes/SoftOrange/{0}/styles.css"  CssPostfix="SoftOrange" 

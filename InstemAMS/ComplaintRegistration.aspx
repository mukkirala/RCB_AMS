<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="ComplaintRegistration.aspx.cs" Inherits="ComplaintRegistration" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" Runat="Server">
 ...
 <%--<asp:UpdatePanel ID="updpnlRefresh" runat="server" UpdateMode="Conditional">--%>
  <ContentTemplate> 
    <div class="col-sm-12">
      <h4><strong><span>Raise Complaint</span></strong></h4>
    <div class="">
        <div class="row">
        <div style="">
           <div class="col-sm-12">
...
where CustodianID=@CustodianID and vAssetMaster.Status !='NVAL'">
       ...
       <asp:ControlParameter ControlID="reqid" Name="CustodianID" />
            ...
            <br />
                ...
                <div class="row">
                <div class="col-sm-2">
                   <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text="Select Asset Class:" Font-Size="Large" Width="300px"></dx:ASPxLabel>
                </div>
                    <div class="col-sm-4">
                        <dx:ASPxComboBox ID="cmb_AssetClass" runat="server" ValueField="AssetClassName" TextField="AssetClassName" DataSourceID="AssetClassDS"
                            ValueType="System.String" AutoPostBack="true" CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" Height="25px" CssPostfix="PlasticBlue" Width="300px" SpriteCssFilePath="~/App_Themes/PlasticBlue/{0}/sprite.css">         
                                 <ValidationSettings   ValidationGroup="btn" ErrorTextPosition="Bottom">
						      <ErrorFrameStyle ImageSpacing="4px">
                                  <ErrorTextPaddings PaddingLeft="4px" />
                              </ErrorFrameStyle>
						<RequiredField ErrorText="Please Select the Asset Class " IsRequired="True" />
					</ValidationSettings>
   ...
   <div class="clearfix"></div>
    ...
    <div class="row form_div">
         ...
         <div class="col-sm-4">
            ...
            <br/><br/>
             <div class="col-sm-10">
                 <div class="row">
                <div class="col-sm-2">
                   <dx:ASPxLabel ID="ASPxLabel18" runat="server" Text="Upload File" Width="300px" Font-Size="Large"></dx:ASPxLabel></div>
                     <div class="col-sm-4">
                                <asp:FileUpload ID="FileUpload1" runat="server" CssClass="form-control" Width="300px" Visible="True" />
            ...
            <br/>
             <div class="col-sm-10">
                 <div class="row">
                     ...
                     <div class="col-sm-6">
                    <dx:ASPxButton ID="ASPxButton1" runat="server" Text="Submit" OnClick="ASPxButton1_Click" CssFilePath="~/App_Themes/SoftOrange/{0}/styles.css" CssPostfix="SoftOrange" 
     ...
     <dx:ASPxGridView ID="AssetList" runat="server" AutoGenerateColumnsASPxGridView1="False"  style="width:100%"  OnHtmlDataCellPrepared="AssetList_HtmlDataCellPrepared" DataSourceID="SqlDataSource3"  KeyFieldName="ComplaintID"  CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css"  CssPostfix="PlasticBlue" AutoGenerateColumns="False">
        <Columns>
  ...
  <%--  <dx:GridViewDataTextColumn FieldName="FileDocument" VisibleIndex="11" Caption="Custodian Department" Visible="false">
   ...
   <%-- <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ConnectionStrings:InstemSAPConnectionString %>" 
       ...
       <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
        ...
        SelectCommand="SELECT ComplaintRegistration.ComplaintID,EmployeeID,MainAssetNumber,AssetClass,AssetDesc,EmployeeName,Concat(ComplaintTransaction.USR_ID+'__','C0',ComplaintTransaction.Sequence) as complaintsequence,EmployeeDepartment,EmployeeDesignation,ServiceTypeMaster.ServiceTypeName, ComplaintRegistration.CreatedDate,ComplaintTransaction.Status,Complaint_Description FROM  [ComplaintRegistration]  
...
inner join ServiceTypeMaster on ServiceTypeMaster.ServiceTypeID=ComplaintRegistration.ServiceTypeID  Where EmployeeID=@EmployeeID and (ComplaintTransaction.Status='Pending' or ComplaintTransaction.Status='Re_Open') and ComplaintRegistration.ComplaintType IS NULL">
...
<%--inner join InstemSAP..AssetTypeMaster on AssetTypeMaster.AssetTypeID=EmployeeAssetRequest.AssetTypeID
 ...
 <%--<asp:SqlDataSource ID="LocationSqlDataSource1" runat="server" ConnectionString="<%$ConnectionStrings:InstemAMSConnectionString %>" SelectCommand="select * from LocationMaster">
        ...
        SelectCommand="Select * From InstemSAP..vAssetMaster where CustodianID=@EmployeeID and vAssetMaster.Status !='NVAL' and vAssetMaster.AssetClass=@AssetClass">
    <SelectParameters>
        <asp:SessionParameter name="EmployeeID" SessionField="UserID"/>

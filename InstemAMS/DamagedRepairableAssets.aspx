<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DamagedRepairableAssets.aspx.cs" Inherits="DamagedRepairableAssets" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="col-sm-12" >
     ...
     <table style="margin-right:20px">
        <tr>
            <td class="style10">
           <span><strong>Assets Damaged But Repairable</strong></span>
            </td>
    ...
    <asp:SqlDataSource ID="SqlDSGrid" runat="server" ConnectionString="<%$ ConnectionStrings:InstemSAPConnectionString %>" SelectCommand="Select * from InstemSAP..AssetMaster where AssetMaster.Status='AREP'"></asp:SqlDataSource>                                     

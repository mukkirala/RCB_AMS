<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AddAssetSapCodeMaster.aspx.cs" Inherits="AddAssetSapCodeMaster" %>
...
<br />
    ...
    <table style="margin-left:55px" class="style1">
        <tr>
            <td class="style2">
                Asset Sap Code<span class="style3"><strong>*</strong></span></td>
            <td class="style5">
                <dx:ASPxTextBox ID="txt_sapcode" runat="server" Width="170px"
                    MaxLength="7">
                </dx:ASPxTextBox>
            </td>
            <td class="style6">
    ...
    <br />
    <strong style="margin-left:55px; color: #000000; font-size: medium;">Edit/Delete Asset SAP Code
    </strong>
    ...
    AutoGenerateColumns="False"  KeyFieldName="AssetSapID"
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="AssetSapID" VisibleIndex="1">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="AssetSapCode" VisibleIndex="2">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
        </Columns>

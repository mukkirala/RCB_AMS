<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ApproveAssetReturnRequest.aspx.cs" Inherits="ApproveAssetReturnRequest" %>
 ...
 <div class="col-sm-12">
     ...
     <strong>Requester Details</strong>
         ...
         <div class="row form_div">
            ...
            <div class="col-sm-4">
                <dx:ASPxLabel ID="reqdeptcode" runat="server" Font-Bold="true" ForeColor="Blue" Text="">
						 </dx:ASPxLabel>

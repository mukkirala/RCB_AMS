<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="EngineerPendingComplaints.aspx.cs" Inherits="EngineerPendingComplaints" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
       <div class="container cnt_div" cssclass="container">
         <div class="row cnt_div">
              <h4>  <strong>Work In Progess Complaints</strong></h4>
                   <div class="col-sm-12">
                   <dx:ASPxGridView ID="ASPxGridView1" runat="server" KeyFieldName="ComplaintTransactionID" Width="95%" OnRowCommand="ASPxGridView1_RowCommand" OnHtmlDataCellPrepared="ASPxGridView1_HtmlDataCellPrepared" OnCustomUnboundColumnData="ASPxGridView1_CustomUnboundColumnData" ClientInstanceName="grid" AutoGenerateColumns="False"  CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" CssPostfix="PlasticBlue" DataSourceID="SqlDataSource1">
                <Columns>
                    ...
                    <dx:GridViewDataColumn FieldName="complaintsequence" VisibleIndex="0" Caption="Complaint ID" width="80px">
                     ...
                     <dx:GridViewDataTextColumn FieldName="AssetDesc" VisibleIndex="2" Caption="Asset Name" >
                           ...
                           <dx:GridViewDataTextColumn FieldName="CreatedDate" VisibleIndex="4">
                                 <Settings AutoFilterCondition="Contains"/>
                           </dx:GridViewDataTextColumn>
                          
                          <dx:GridViewDataTextColumn FieldName="ComplaintTransactionID" VisibleIndex="2" Visible="false">
                                <Settings AutoFilterCondition="Contains"/>
                          </dx:GridViewDataTextColumn>
                     ...
                     <dx:GridViewDataTextColumn FieldName="ComplaintType" VisibleIndex="5" Caption=" Type of Complaint" width="70px">
                               <Settings AutoFilterCondition="Contains"/>
                          </dx:GridViewDataTextColumn>

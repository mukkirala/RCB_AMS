...
public partial class ViewAssetBuyBack : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("AssetBuyBack.aspx");
    }
    ...
    protected void BuybackAssetList_RowCommand(object sender, DevExpress.Web.ASPxGridView.ASPxGridViewRowCommandEventArgs e)
    {
        ...
        Session["Requestedby"] = BuybackAssetList.GetRowValuesByKeyValue(e.KeyValue, "RequestBy").ToString();
        ...
        Session["EmpDeptCode"] = BuybackAssetList.GetRowValuesByKeyValue(e.KeyValue, "CustDepartmentCode").ToString();
        Response.Redirect("/ApproveAssetBuybackRequest.aspx");
    }

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AdminApproveAssetReturn.aspx.cs" Inherits="AdminApproveAssetReturn" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
 ...
 <div class="col-sm-12">
     ...
     <br />
      ...
      <div class="row">   
          <div class="col-sm-12"><strong>Asset Details</strong>
          <hr/>
        </div>
      </div>
      <div class="row form_div">
         ...
         <div class="col-sm-4">
            ...
            <div class="col-sm-2">
                   <dx:ASPxLabel ID="ASPxLabel7" runat="server" Text="Main Asset Number:" Font-Size="Large"></dx:ASPxLabel>            
                </div>
         <div class="col-sm-4">
      ...
      <div class="row form_div">
       ...
       <div class="row form_div">
             <div class="col-sm-2">
                   <dx:ASPxLabel ID="ASPxLabel11" runat="server" Text="Current Location:" Font-Size="Large"></dx:ASPxLabel>            
                </div>
         <div class="col-sm-4">
    ...
    <div class="row form_div">
         ...
         <div class="col-sm-4">
           <asp:TextBox ID="txt_cmt" runat="server" TextMode="MultiLine" ForeColor="Black" Rows="2" Columns="22"></asp:TextBox>
             <asp:RequiredFieldValidator ID="rfv_txt_cmt" runat="server" ControlToValidate="txt_cmt"
    InitialValue="" ErrorMessage="Please enter Remarks" Display="Dynamic" ForeColor="Red">

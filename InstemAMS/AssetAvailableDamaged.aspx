<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AssetAvailableDamaged.aspx.cs" Inherits="AssetAvailableDamaged" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
     ...
     <div class="col-sm-12">
        ...
        <tr>
            <td class="style10">
           <span><strong>Assets Available But Damaged</strong></span>
            </td>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AdminViewLocationChange.aspx.cs" Inherits="AdminViewLocationChange" %>
<%@ Register assembly="DevExpress.Web.ASPxGridView.v11.1" namespace="DevExpress.Web.ASPxGridView" tagprefix="dx" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
<strong> <asp:Label ID="Label1" runat="server" Text="View Location Transfer Requests"></asp:Label></strong> <br />
  <div class="table-responsive">
     ...
     <dx:ASPxGridView ID="AssetList" runat="server" AutoGenerateColumnsASPxGridView1="False" 
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="LocationID" VisibleIndex="4" Caption="LocationID" Visible="false" >
    <Settings AutoFilterCondition="Contains" />
</dx:GridViewDataTextColumn>
     ...
     <Settings AutoFilterCondition="Contains" />
             ...
             <dx:GridViewDataTextColumn FieldName="CLocation" VisibleIndex="3" Caption="Current Wing">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="CBlock" VisibleIndex="3" Caption="Current Floor">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="CLocationDesc" VisibleIndex="3" Caption="Current LAB">
    <Settings AutoFilterCondition="Contains" />
</dx:GridViewDataTextColumn>
            ...
            <dx:GridViewDataTextColumn FieldName="CustodianComments" VisibleIndex="5" Caption="Employee Remarks">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
             <dx:GridViewDataTextColumn FieldName="ApproverComments" VisibleIndex="5" Caption="Approver Remarks" Visible="false">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
 ...
 <asp:SqlDataSource ID="AssetListSqlDataSource3" runat="server" 
        ...
        SelectCommand="SELECT LocationChangeID,EmployeeLocationChange.AssetID,AssetDesc as AssetTypeName,LocationMaster.Location,LocationMaster.LocationCode,
     LocationMaster.Block,AssetMaster.Location as CLocation,AssetMaster.Block as CBlock,AssetMaster.LocationDesc as CLocationDesc,EmployeeLocationChange.ToLocation,
     Concat(EmployeeLocationChange.EmployeeID+'__',EmployeeLocationChange.LocationSequence) as EmployeeID,RequestBy as Requestedby,
     EmployeeLocationChange.CustodianDepartment,CustDesignation,EmployeeLocationChange.Status,Date,CustodianComments,ApproverID,ApproverName,
     ApproverDesignation,ApproverDeptCode,ApproverDepartment,ApproverComments,CustodianComments,EmployeeLocationChange.LocationID  
     FROM EmployeeLocationChange inner join InstemSAP..AssetMaster on AssetMaster.AssetID=EmployeeLocationChange.AssetID 
     inner join InstemAMS..LocationMaster on LocationMaster.LocationID=EmployeeLocationChange.LocationID  
     where EmployeeLocationChange.Status='Request Sent To Admin' order by LocationChangeID desc">
...
<asp:SqlDataSource ID="DetailDS" runat="server" 
  ...
  <strong><asp:Label ID="Label2" runat="server" Text="Approved Location Tranfer Requests"></asp:Label></strong> <br />
    ...
    <asp:SqlDataSource ID="AssetListSqlDataSource4" runat="server" 
        ConnectionString="<%$ ConnectionStrings:InstemAMSConnectionString %>" 
        SelectCommand="SELECT LocationChangeID,EmployeeLocationChange.AssetID,AssetDesc as AssetTypeName,LocationMaster.Location,LocationMaster.LocationCode,LocationMaster.Block,EmployeeLocationChange.ToLocation,Concat(EmployeeLocationChange.EmployeeID+'__',EmployeeLocationChange.LocationSequence) as EmployeeID,RequestBy as Requestedby,EmployeeLocationChange.CustodianDepartment,CustDesignation,EmployeeLocationChange.Status,Date,CustodianComments,ApproverID,ApproverName,ApproverDesignation,ApproverDeptCode,ApproverDepartment,AdminID,AdminName,ApproverComments,AdminComments FROM EmployeeLocationChange inner join InstemSAP..AssetMaster on AssetMaster.AssetID=EmployeeLocationChange.AssetID inner join InstemAMS..LocationMaster on LocationMaster.LocationID=EmployeeLocationChange.LocationID  where EmployeeLocationChange.Status='Approved' order by LocationChangeID desc">

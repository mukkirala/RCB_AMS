<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ViewAssetsTransferred.aspx.cs" Inherits="ViewAssetsTransferred" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
     ...
     <div class="col-sm-12">
        ...
        <tr>
            <td class="style10">
           <span><strong>Asset Location Transferred</strong></span>
            </td>
       ...
       <div class=" table-responsive">
        <dx:ASPxGridView ID="ASPxGridView1"  runat="server" AutoGenerateColumns="False" 
         ...
         <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="MainAssetNumber" VisibleIndex="4" Caption="AssetNumber"  >
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
            ...
            <dx:GridViewDataTextColumn FieldName="SerialNumber" VisibleIndex="10" Caption="Serial Number" >
             ...
             <dx:GridViewDataTextColumn FieldName="LocationID" VisibleIndex="12" Caption="LocationID">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>          
            
            <dx:GridViewDataTextColumn FieldName="Location" VisibleIndex="13" Caption="Wing">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>   
           ...
           <dx:GridViewDataTextColumn FieldName="BLOCK" VisibleIndex="14" Caption="Floor">
             ...
             <dx:GridViewDataTextColumn FieldName="LocationDesc" VisibleIndex="14" Caption="LAB">
     <Settings AutoFilterCondition="Contains" />
 </dx:GridViewDataTextColumn>
    ...
    <asp:SqlDataSource ID="SqlDSGrid" runat="server" ConnectionString="<%$ ConnectionStrings:InstemSAPConnectionString %>" SelectCommand="Select * from InstemSAP..AssetMaster where AssetMaster.Status='LTRF'"></asp:SqlDataSource>                                     

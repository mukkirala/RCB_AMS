<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ViewAssetIdle.aspx.cs" Inherits="ViewAssetIdle" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
     ...
     <table style="margin-right:20px">
        <tr>
            <td class="style10">
           <span><strong>Assets By IDLE</strong></span>
            </td>
    ...
    <asp:SqlDataSource ID="SqlDSGrid" runat="server" ConnectionString="<%$ ConnectionStrings:InstemSAPConnectionString %>" SelectCommand="Select * from InstemSAP..AssetMaster where AssetMaster.Status='IDLE' "></asp:SqlDataSource>                                     

...
public partial class ViewAssetDetails : System.Web.UI.Page
{
    ...
    protected void btn_search_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            string query11 = "SELECT MainAssetNumber FROM [AssetMaster] where AssetID = '" + gridlkup_Asset.Value + "'";
            SqlDataAdapter da11 = new SqlDataAdapter(query11, myConnection2);
            ...
            if (dt11.Rows.Count > 0)
            {
                ...
                string query2 = "SELECT ImagesMapId,ImageLocation as Assetimage from AssetImageMapping where AssetID='" + gridlkup_Asset.Value + "'";

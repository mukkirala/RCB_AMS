<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AssetMapView.aspx.cs" Inherits="AssetMapView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
     ...
     <table style="margin-right:20px">
        <tr>
            <td class="style10">
            <span><strong>Assets Details</strong></span>
            </td>
        ...
        <dx:ASPxGridView ID="ASPxGridView1"  runat="server" AutoGenerateColumns="False" 
                    DataSourceID="SqlDSGrid" KeyFieldName="AssetID"        OnRowCommand="ASPxGridView1_RowCommand"         
                    CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" CssPostfix="PlasticBlue" 
                    Width="950px">
        <Columns>
            <dx:GridViewDataTextColumn FieldName="AssetID" Visible="false" ReadOnly="True" VisibleIndex="1">
            ...
            <dx:GridViewDataTextColumn FieldName="AssetDesc" VisibleIndex="3" Caption="Asset Description" >
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="Latitude" VisibleIndex="4" Caption="Latitude" >
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="Longitude" VisibleIndex="5" Caption="Longitude">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
          <dx:GridViewDataTextColumn FieldName="" VisibleIndex="6">
                     <DataItemTemplate>
                         <asp:LinkButton ID="btn_view" Text="View" runat="server" OnClientClick="SetTarget();" CommandName="View">View on Map</asp:LinkButton>
                     </DataItemTemplate>
                </dx:GridViewDataTextColumn>

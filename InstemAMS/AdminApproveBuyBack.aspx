<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AdminApproveBuyBack.aspx.cs" Inherits="AdminApproveBuyBack" %>
 ...
 <div class="col-sm-12">
     ...
     <strong>Requester Details</strong>
         ...
         <div class="row form_div">
            ...
            <div class="col-sm-4">
                <dx1:ASPxLabel ID="reqdeptname" runat="server"  Text="" ForeColor="Blue" Font-Bold="True">
						 </dx1:ASPxLabel>           
            </div>
                <div class="col-sm-2">
            ...
            <div class="col-sm-4">
                <dx:ASPxLabel ID="reqdesig" runat="server" Font-Bold="true" ForeColor="Blue" Text="">
						 </dx:ASPxLabel>
        ...
        <div class="row form_div">
            ...
            <div class="col-sm-4">
                <dx1:ASPxLabel ID="lbl_date" runat="server"  Text="" ForeColor="Blue" Font-Bold="True">
						 </dx1:ASPxLabel>           
            </div>
        </div>
     <br />
